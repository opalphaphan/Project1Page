...
//     // Assuming userData contains keys: 'fullname', 'username', 'email'
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Summary'),
//       ),
...
//           children: <Widget>[
//             Text('Summary Page', style: TextStyle(fontSize: 24)),
//             SizedBox(height: 20),
...
//             ElevatedButton(
//                onPressed: () {
//               Navigator.pushNamed(context, '/main2'); // Navigate to Main2Screen
//               },
//               child: Text('Finish'),
//             ),
//           ],
