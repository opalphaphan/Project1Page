...
//                       _buildBioSection(),
//                       SizedBox(height: 20),
//                       _buildDataList('Liked Books', 'likedBooks'),
//                       SizedBox(height: 20),
//                       _buildDataList('Saved Books', 'savedBooks'),
//                       SizedBox(height: 20),
//                       _buildDataList('Finished Books', 'finishedBooks'),
//                     ],
//                   ),
//                 ),
//               ),
...
//   Widget _buildDataList(String title, String collection) {
//     return Container(
//       padding: EdgeInsets.all(16),
...
class _ProfilePageState extends State<ProfilePage> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      _buildBioSection(),
                      SizedBox(height: 20),
                      if (currentCollection.isNotEmpty) _buildDataList(currentCollection),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildButton(BuildContext context, String title, IconData iconData, String collection) {
